...
.PHONY: help dev api web db-up object-bucket db-status db-migrate db-reset test test-api test-postgres test-web build build-api build-web sync-static production-readiness fmt clean
